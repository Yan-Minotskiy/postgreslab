...
3. Построить ER-диаграмму демонстрационной базы данных (можно использовать сторонний софт для построения диаграмм, например datagrip)
4. Составить 20 уникальных и работающих запросов к базе данных
